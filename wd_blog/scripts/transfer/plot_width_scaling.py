...
CSV_PATH = "/afs/cs.stanford.edu/u/kaiyue/TPU/Marins/square_learning_rate/wandb_hyperball_runs.csv"
...
def make_plots(csv_path: str = CSV_PATH, output_dir: str = OUTPUT_DIR) -> None:
    ...
    df = df[(df["num_layers"] == 4.0) & (df["min_lr_ratio"] == 0.0) & (df["loss"] < 5.0)].copy()

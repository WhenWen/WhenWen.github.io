...
\begin{tikzpicture}[>=Latex, scale=1.5, font=\small]
    ...
    \draw[->, ultra thick, green!60!black] (Wt) -- (Wt_inter) 
        ...
        {$-\eta R \cdot {\mathbf{u}}_t / \|\mathbf{u}_t \|_F$};
    ...
    % Fixed Norm Label
    \node[anchor=north west, blue!40!black] at (-\R+0.6, -\R+1.1) {Fixed Weight Norm};
    \node[anchor=north west, blue!40!black] at (-\R+1.1, -\R+1.5) {$\|\mathbf{W}\|_F = R$};
